...
//+	alert("picif pre prep_pics");	//	--	--	 ghh 11-12-8	--	--	--	--	--	--	--	--	--

	opacitee=2;
	for (var i=0; i<=lenPics; ++i) {
		prep_pic( them[i] );
//	if(i==11) alert("picif 11 prep_pics "+lenPics);	//	--	--	 ghh 11-12-8	--	--	--	--	--	--	--	--	--
if(i>=90) alert(i+" picif >=90 prep_pics "+lenPics);	//	--	--	 ghh 11-12-8	--	--	--	--	--	--	--	--	--
//	if(i==95) alert("picif 95 prep_pics "+lenPics);	//	--	--	 ghh 11-12-8	--	--	--	--	--	--	--	--	--

}

alert("picif pre PU alert");	//	--	--	 ghh 11-12-8	--	--	--	--	--	--	--	--	--
...
alert("picif pre add_pui");	//	--	--	 ghh 11-12-8	--	--	--	--	--	--	--	--	--

add_pui();	//	add popup window for UI

alert("picif post add_pui");	//	--	--	 ghh 11-12-8	--	--	--	--	--	--	--	--	--
